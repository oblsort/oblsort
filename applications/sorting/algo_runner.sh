...
# Algorithms:
ALGOs=(KWAYBUTTERFLYOSORT KWAYDISTRIBUTIONOSORT KWAYDISTRIBUTIONOSORTSHUFFLED EXTMERGESORT KWAYBUTTERFLYOSHUFFLE CABUCKETSORT BITONICSORT ORSHUFFLE CABUCKETSHUFFLE BITONICSHUFFLE)
